  ...
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>
        Hear from our satisfied students who have transformed their careers with our courses. Our platform has empowered <br />thousands of learners to achieve their goals and excel in their fields.
      </p>
